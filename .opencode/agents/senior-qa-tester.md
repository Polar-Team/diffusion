...
permission:
  edit:
    "*": deny
    "dev-new-features/internal/**/*_test.go": allow
    "dev-new-features/cmd/**/*_test.go": allow
    "dev-new-features/tests/**": allow
    "dev-new-features/diffusion-test/**": allow
    "dev-new-features/diffusion_tests/**": allow
    "dev-new-features/*_test.go": allow
    "dev-new-features/testdata/**": allow
  bash:
    "*": ask
    "go test ./...": allow
    "go test -v ./...": allow
    "go test -race ./...": allow
    "go test -cover ./...": allow
    "go test -coverprofile=coverage.out ./...": allow
    "go tool cover -func=coverage.out": allow
    "go tool cover -html=coverage.out": allow
