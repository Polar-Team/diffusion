...
func TestDefaultConstants(t *testing.T) {
	tests := []struct {
		...
		{"DefaultRegistryServer", DefaultRegistryServer, "ghcr.io"},
		{"DefaultRegistryProvider", DefaultRegistryProvider, "Public"},
		{"DefaultMoleculeContainerName", DefaultMoleculeContainerName, "polar-team/diffusion-molecule-container"},
	}
...
func TestValidateDefaultRegistryProvider(t *testing.T) {
	err := ValidateRegistryProvider(DefaultRegistryProvider)
	if err != nil {
